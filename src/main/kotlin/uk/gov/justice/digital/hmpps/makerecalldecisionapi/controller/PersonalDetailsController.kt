...
class PersonalDetailsController {
  ...
  @Operation(summary = "WIP: Returns personal details")
  fun personalDetails(@PathVariable("crn") crn: Crn): String {
    log.info("Personal details endpoint hit for CRN: $crn")

 ...
 [
   {
   ...
   },
    {
     "active": false,
     "awaitingPsr": true,
     "breachEnd": "2019-05-13",
     "convictionDate": "2020-06-10",
     "convictionId": 2500000002,
     "courtAppearance": {
       "appearanceDate": "2017-09-04T00:00:00",
       "appearanceType": {
         "code": "ABC124",
         "description": "Some description"
       },
       "courtAppearanceId": 2500000009,
       "courtCode": "SHEFMC",
       "courtName": "Sheffield Magistrates Court",
       "crn": "$crn"
     },
     "custody": {
       "bookingNumber": "V74113",
       "institution": {
         "code": "string",
         "description": "string",
         "establishmentType": {
       ...
       "keyDates": {
         "conditionalReleaseDate": "2019-06-23",
         "expectedPrisonOffenderManagerHandoverDate": "2019-06-23",
         "expectedPrisonOffenderManagerHandoverStartDate": "2019-06-23",
         "expectedReleaseDate": "2019-06-23",
         "hdcEligibilityDate": "2019-06-23",
         "licenceExpiryDate": "2019-06-23",
         "paroleEligibilityDate": "2019-06-23",
         "postSentenceSupervisionEndDate": "2019-06-23",
         "sentenceExpiryDate": "2019-06-23"
       },
       "sentenceStartDate": "2020-04-26",
       "status": {
         "code": "ABC124",
         "description": "Some description"
       }
     },
     "failureToComplyCount": 99,
     "inBreach": true,
     "index": 1,
     "latestCourtAppearanceOutcome": {
       "code": "ABC124",
     ...
     "offences": [
       {
         "createdDatetime": "2020-04-26T20:39:47.778Z",
         "detail": {
           "abbreviation": "string",
           "cjitCode": "string",
           "code": "string",
         ...
         "lastUpdatedDatetime": "2020-04-26T20:39:47.778Z",
         "mainOffence": true,
         "offenceCount": 0,
         "offenceDate": "2020-04-26T20:39:47.778Z",
         "offenceId": "string",
         "offenderId": 0,
         "tics": 0,
         "verdict": "string"
     ...
     "orderManagers": [
       {
         "dateEndOfAllocation": "2020-04-26T20:39:47.778Z",
         "dateStartOfAllocation": "2020-04-26T20:39:47.778Z",
         "gradeCode": "string",
         "name": "string",
         "officerId": 0,
         "probationAreaId": 0,

  ...
  fun `retrieves risk data`() {
    runTest {
      ...
      webTestClient.get()
        ...
        .jsonPath("$.predictorScores.historical[1].scores.OGP.level").isEqualTo(FourLevelRiskScoreLevel.HIGH.toString())
        ...
        .jsonPath("$.predictorScores.historical[1].scores.OVP.level").isEqualTo(FourLevelRiskScoreLevel.HIGH.toString())
        ...
        .jsonPath("$.predictorScores.historical[1].scores.OSPC.level").isEqualTo(FourLevelRiskScoreLevel.HIGH.toString())
        ...
        .jsonPath("$.predictorScores.historical[1].scores.OSPI.level").isEqualTo(ThreeLevelRiskScoreLevel.HIGH.toString())
        ...
        .jsonPath("$.predictorScores.historical[1].scores.OGRS.level").isEqualTo(FourLevelRiskScoreLevel.HIGH.toString())

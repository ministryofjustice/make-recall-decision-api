  ...
  fun `retrieves risk data when ARN Scores are null`() {
    runTest {
      ...
      webTestClient.get()
        ...
        .jsonPath("$.predictorScores.historical[1].date").isEqualTo("2020-06-16")
        .jsonPath("$.predictorScores.historical[1].scores.OGP").isEqualTo(null)
        .jsonPath("$.predictorScores.historical[1].scores.OVP").isEqualTo(null)
        .jsonPath("$.predictorScores.historical[1].scores.RSR").isEqualTo(null)
        .jsonPath("$.predictorScores.historical[1].scores.OSPC").isEqualTo(null)
        .jsonPath("$.predictorScores.historical[1].scores.OSPI").isEqualTo(null)
        .jsonPath("$.predictorScores.historical[1].scores.OGRS").isEqualTo(null)
  ...
  fun `retrieves risk data`() {
    runTest {
      ...
      webTestClient.get()
        ...
        .jsonPath("$.predictorScores.historical[0].scores.OSPC.score").isEqualTo(3.45)
        ...
        .jsonPath("$.predictorScores.historical[0].scores.OSPI.score").isEqualTo(5)
        ...
        .jsonPath("$.predictorScores.historical[1].scores.OSPC.score").isEqualTo(0)
        ...
        .jsonPath("$.predictorScores.historical[1].scores.OSPI.score").isEqualTo(0)

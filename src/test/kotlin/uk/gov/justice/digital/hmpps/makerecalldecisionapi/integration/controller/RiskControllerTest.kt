  ...
  fun `retrieves risk data`() {
    runTest {
      ...
      webTestClient.get()
        ...
        .jsonPath("$.predictorScores.current.scores.OGP.oneYear").isEqualTo(0.0)
        .jsonPath("$.predictorScores.current.scores.OGP.twoYears").isEqualTo(0.0)
        ...
        .jsonPath("$.predictorScores.historical[0].scores.OGP.oneYear").isEqualTo(0.0)
        .jsonPath("$.predictorScores.historical[0].scores.OGP.twoYears").isEqualTo(0.0)
        ...
        .jsonPath("$.predictorScores.historical[0].scores.OGRS.oneYear").isEqualTo(0.0)
        .jsonPath("$.predictorScores.historical[0].scores.OGRS.twoYears").isEqualTo(0.0)

...
//  }
  ...
  fun `update roshSummary with refresh and get recommendation`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[0].riskTo").isEqualTo("Children")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[0].community").isEqualTo("HIGH")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[0].custody").isEqualTo("LOW")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[1].riskTo").isEqualTo("Public")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[1].community").isEqualTo("HIGH")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[1].custody").isEqualTo("LOW")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[2].riskTo").isEqualTo("Known Adult")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[2].community").isEqualTo("HIGH")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[2].custody").isEqualTo("HIGH")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[3].riskTo").isEqualTo("Staff")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[3].community").isEqualTo("MEDIUM")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[3].custody").isEqualTo("VERY_HIGH")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[4].riskTo").isEqualTo("Prisoners")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[4].community").isEqualTo("")
      .jsonPath("$.roshSummary.riskOfSeriousHarm.risks[4].custody").isEqualTo("VERY_HIGH")

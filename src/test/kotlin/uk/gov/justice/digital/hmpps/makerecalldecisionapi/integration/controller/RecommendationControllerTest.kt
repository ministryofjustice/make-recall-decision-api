...
class RecommendationControllerTest() : IntegrationTestBase() {
  ...
  @Test
  fun `update with manager recall decision`() {
    ...
    updateRecommendation(
      ...
      "previousReleases, previousRecalls, mappa, indexOffenceDetails, convictionDetail, personOnProbation"
    )
    ...
    webTestClient.patch()
      ...
      .contentType(MediaType.APPLICATION_JSON)
      .body(
        BodyInserters.fromValue(managerRecallDecisionRequest(decision = "RECALL"))
      )
    ...
    webTestClient.get()
      ...
      .jsonPath("$.alternativesToRecallTried.selected[0].details")
      .isEqualTo("We sent a warning letter on 27th July 2022")
      ...
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[0].text")
      .isEqualTo("Be of good behaviour")
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[0].value").isEqualTo("GOOD_BEHAVIOUR")
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[1].text")
      .isEqualTo("Not to commit any offence")
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[1].value").isEqualTo("NO_OFFENCE")
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[2].text")
      .isEqualTo("Tell your supervising officer if you use a name which is different to the name or names which appear on your licence.")
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[2].value").isEqualTo("NAME_CHANGE")
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[3].text")
      .isEqualTo("Tell your supervising officer if you change or add any contact details, including phone number or email.")
      .jsonPath("$.licenceConditionsBreached.standardLicenceConditions.allOptions[3].value")
      .isEqualTo("CONTACT_DETAILS")
      .jsonPath("$.licenceConditionsBreached.additionalLicenceConditions.selected[0]").isEqualTo("NST14")
      .jsonPath("$.licenceConditionsBreached.additionalLicenceConditions.allOptions[0].title")
      .isEqualTo("Disclosure of information")
      .jsonPath("$.licenceConditionsBreached.additionalLicenceConditions.allOptions[0].details")
      .isEqualTo("Notify your supervising officer of any intimate relationships")
      .jsonPath("$.licenceConditionsBreached.additionalLicenceConditions.allOptions[0].note")
      .isEqualTo("Persons wife is Joan Smyth")
      ...
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.selected[0].details")
      .isEqualTo("Some behaviour similar to index offence")
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.selected[0].value")
      .isEqualTo("BEHAVIOUR_SIMILAR_TO_INDEX_OFFENCE")
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.selected[1].details")
      .isEqualTo("Behaviour leading to sexual or violent behaviour")
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.selected[1].value")
      .isEqualTo("BEHAVIOUR_LEADING_TO_SEXUAL_OR_VIOLENT_OFFENCE")
      ...
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.allOptions[0].text")
      .isEqualTo("Some behaviour similar to index offence")
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.allOptions[0].value")
      .isEqualTo("BEHAVIOUR_SIMILAR_TO_INDEX_OFFENCE")
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.allOptions[1].text")
      .isEqualTo("Behaviour leading to sexual or violent behaviour")
      .jsonPath("$.indeterminateOrExtendedSentenceDetails.allOptions[1].value")
      .isEqualTo("BEHAVIOUR_LEADING_TO_SEXUAL_OR_VIOLENT_OFFENCE")
      ...
      .jsonPath("$.whyConsideredRecall.allOptions[1].text")
      .isEqualTo("Contact with your probation practitioner has broken down")
      .jsonPath("$.whyConsideredRecall.allOptions[2].value").isEqualTo("RISK_INCREASED_AND_CONTACT_STOPPED")
      .jsonPath("$.whyConsideredRecall.allOptions[2].text")
      .isEqualTo("Your risk is assessed as increased and contact with your probation practitioner has broken down")
      ...
      .jsonPath("$.recallConsideredList[0].recallConsideredDetail")

...
class RecommendationControllerTest() : IntegrationTestBase() {
  ...
  fun `update and get recommendation`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.victimsInContactScheme.selected").isEqualTo("YES")
      .jsonPath("$.victimsInContactScheme.allOptions[0].value").isEqualTo("YES")
      .jsonPath("$.victimsInContactScheme.allOptions[0].text").isEqualTo("Yes")
      .jsonPath("$.victimsInContactScheme.allOptions[1].value").isEqualTo("NO")
      .jsonPath("$.victimsInContactScheme.allOptions[1].text").isEqualTo("No")
      .jsonPath("$.victimsInContactScheme.allOptions[2].value").isEqualTo("NOT_APPLICABLE")
      .jsonPath("$.victimsInContactScheme.allOptions[2].text").isEqualTo("N/A")

...
dependencies {
  ...
  implementation("io.opentelemetry:opentelemetry-api:1.63.0") // can this be removed? I think we might already be pulling it transitively
  ...
  implementation("org.postgresql:postgresql:42.7.12") // hmpps-kotlin-spring-boot-starter pulls in 42.7.10 - should we remove this line here and leave it up to the starter?
  ...
  testImplementation(platform("io.rest-assured:rest-assured-bom:5.5.7"))
  ...
  testImplementation("uk.gov.justice.service.hmpps:hmpps-subject-access-request-lib:2.6.0")
  testImplementation("uk.gov.justice.service.hmpps:hmpps-kotlin-spring-boot-starter-test:2.5.0")
  testImplementation("uk.gov.justice.service.hmpps:hmpps-kotlin-spring-boot-test-autoconfigure:2.5.0")
